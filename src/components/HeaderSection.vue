<template>
    <div class="flex items-center justify-evenly p-2 bg-gradient-to-r from-blue-800 to-blue-900 shadow-md">
        <h1 class="text-xl md:text-2xl text-center text-blue-100 font-bold tracking-wide">Weather Channel Montenegro</h1>
        <div class="relative">
            <input placeholder="Search for city"
                class="rounded-full py-2 px-4 outline-none focus:outline-none bg-blue-50 w-[200px] md:w-[300px] placeholder:text-blue-700 text-blue-800"
